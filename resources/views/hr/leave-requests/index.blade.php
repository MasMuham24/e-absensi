...
@section('header_title', 'Pengajuan Cuti')

@section('content')
<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-xl font-bold text-slate-800">Pengajuan Cuti</h2>
            <p class="text-sm text-slate-500 mt-1">Approval dan riwayat pengajuan cuti karyawan.</p>
        </div>
    </div>
                    ...
                    @forelse($leaveRequests as $item)
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                ...
                                @else
                                    <a href="{{ route('hr.leave-requests.show', $item->id) }}" class="text-slate-600 hover:text-indigo-600">
                        ...
                        <tr>
                            <td colspan="7" class="px-6 py-12 text-center text-slate-400 text-sm">
                                <div class="flex flex-col items-center justify-center space-y-2">
                                    ...
                                    <span>Belum ada pengajuan cuti.</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
