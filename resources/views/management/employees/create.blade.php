...
<div class="flex items-center justify-center min-h-[calc(100vh-10rem)]">
    <div class="w-full max-w-2xl">
        <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h2 class="text-xl font-semibold text-slate-800">Tambah Karyawan Baru</h2>
                <p class="text-sm text-slate-500 mt-1">Masukkan informasi karyawan yang akan ditambahkan.</p>
            </div>
                        ...
                        <div>
                            ...
                            <select name="position_id" id="position_id" required
                                ...
                                @foreach($positions as $pos)
                                    <option value="{{ $pos->id }}" data-dept="{{ $pos->departement_id }}" {{ old('position_id') == $pos->id ? 'selected' : '' }}>
